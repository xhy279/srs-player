...
//
// This file is a modified version of the SRS SDK.
...
function SrsRtcWhipWhepAsync() {
  ...
  self.play = async function (url, options) {
    ...
    if (options.audio.enable) {
      self.pc.addTransceiver('audio', options.audio.transceiverOptions)
    }
    if (options.video.enable) {
      self.pc.addTransceiver('video', options.video.transceiverOptions)
    }
